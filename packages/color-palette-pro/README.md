...
This library provides programmatic color palette generation functions—analogous, triadic, tetradic, complementary, split
complementary, and complex tints & shades manipulations. It relies on mathematically precise adjustments within the
strictly perceptual OKLCH color space, circumventing the commonly known "muddy" or desaturated zones created by basic
HSL interpolations.
