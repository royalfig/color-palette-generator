...
export function generateTetradic(
  ...
  try {
    ...
    if (isAchromatic(baseColorObj))
      return generateNeutralPalette(baseColor, 6, "tetradic", format);
    ...
    if (style === "triangle") {
      ...
      variations = {
        ...
        fourth: {
          light: { l: 0.12 - lightnessModifier, c: 0.75 },
          dark: { l: -0.12 - lightnessModifier, c: 0.95 },
        },
      };
      ...
      if (hue >= 345 || hue < 30) {
        ...
        variations = {
          first: {
            pure: { l: 0.1 - lightnessAdaptation, c: 1.0 },
            muted: { l: -0.05 - lightnessAdaptation, c: 0.8 },
          },
          complement: { l: 0.15 - lightnessAdaptation, c: 0.8 },
          fourth: {
            light: { l: 0.2 - lightnessAdaptation, c: 0.7 },
            dark: { l: -0.2 - lightnessAdaptation, c: 1.2 },
          },
        };
        ...
        variations = {
          first: {
            pure: { l: 0.06 - lightnessAdaptation, c: 0.8 },
            muted: { l: -0.12 - lightnessAdaptation, c: 0.5 },
          },
          complement: { l: 0.08 - lightnessAdaptation, c: 0.85 },
          fourth: {
            light: { l: 0.15 - lightnessAdaptation, c: 0.75 },
            dark: { l: -0.1 - lightnessAdaptation, c: 0.9 },
          },
        };
      }
      ...
      if (lightness > 0.8 && chroma < 0.06) {
        ...
        variations = {
          ...
          fourth: {
            light: { l: 0.05, c: 0.7 },
            dark: { l: Math.max(-0.3, 0.15 - lightness), c: 0.9 },
          },
        };
        ...
        variations = {
          ...
          fourth: {
            light: { l: 0.4, c: 0.9 },
            dark: { l: Math.max(-0.15, 0.15 - lightness), c: 1.3 },
          },
        };
      }
    }
    ...
    tetradicHues.forEach((hue, tetradIndex) => {
      if (tetradIndex === 0) {
        ...
        initialColors.push(
          applyVariation(baseColorObj, variations.complement, finalHue),
        );
    ...
    throw new Error(
      `Failed to generate tetradic colors for ${baseColor}: ${e}`,
    );
  }
}
