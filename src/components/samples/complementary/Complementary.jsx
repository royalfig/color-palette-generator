...
export default function Complementary() {
  ...
  return (
    <>
      ...
      <div ref={container}>
        <SampleNavbar name="Complementary" handler={handleSpecOverlay} />
        <svg
        ...
        >
          ...
          <path
            ...
            strokeOpacity=".5"
            strokeWidth="2"
            d="M176.019-84.725c-18.116 60.846-13.104 184.845 151.874 194.07 164.979 9.226 213.274 31.097 308.006 97.791 94.731 66.695 142.198 170.637 327.859 228.918 185.662 58.282 398.172 69.786 481.222 68.253"
          />
        </svg>
        <div className="complementary-hero">
          ...
          <p>
            The principal color plus another shifted 180&deg; on the color
            wheel.
          </p>
